# taken and slightly modified from https://github.com/WangLibo1995/GeoSeg/blob/main/geoseg/models/FTUNetFormer.py
...
class FTUNetFormer(nn.Module):
    ...
    def __init__(self,
        ...
        self.backbone = SwinTransformer(
            embed_dim=embed_dim, depths=depths, num_heads=num_heads, frozen_stages=freeze_stages, in_chans=in_channels)
        ...
        self.name = "FTUnetFormer_SwinTransformer"
